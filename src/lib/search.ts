...
export const searchIndexes = (rawKeywords: string, rawLog: Uint8Array) => {
...
export const searchLines = (rawKeywords: string, rawLog: Uint8Array, isCaseInsensitive: boolean) => {
